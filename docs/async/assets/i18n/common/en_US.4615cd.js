webpackJsonp(['assets/i18n/common/en_US'], {
  em35: function(e, t) {
    e.exports = {
      价格: 'Price',
      首付: 'Downpayment ',
      ...
      '您有未完成的退款订单，请前往“账单”页面完成退款流程并继续购物。':
        'You have pending refund order(s). Please go to ”Bills” page to complete refund process and continue shopping.',
      ...
      '您现在没有信用额度，请先申请信用额度以启用分期付款购物。':
        "You don't have credit limit now. Please apply for credit limit first to enable installment shopping.",
      立即申请: 'Apply Now',
